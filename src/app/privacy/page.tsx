    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow text-foreground p-4 md:p-8 relative z-10">
        ...
        <article className="prose prose-gray dark:prose-invert max-w-none">
          ...
          <p className="text-muted-foreground mb-8">Effective date: July 14, 2019</p>

          <p className="text-muted-foreground mb-6">
            Pomofocus (&quot;us&quot;, &quot;we&quot;, or &quot;our&quot;) operates the https://pomofocus.io website (hereinafter referred to as the &quot;Service&quot;).
          </p>
          ...
          <h3 className="text-xl font-semibold text-foreground mt-6 mb-4">Types of Data Collected</h3>
          ...
          <h4 className="text-lg font-semibold text-foreground mt-4 mb-2">Tracking & Cookies Data</h4>
          ...
          <p className="text-muted-foreground mb-4">Pomofocus uses the collected data for various purposes:</p>
          <ul className="list-disc list-inside text-muted-foreground mb-8">
          ...
          <p className="text-muted-foreground mb-8">
            Pomofocus will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.
          </p>

          <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">Disclosure Of Data</h2>
          
          <h3 className="text-xl font-semibold text-foreground mt-6 mb-4">Legal Requirements</h3>
          <p className="text-muted-foreground mb-4">
            Pomofocus may disclose your Personal Data in the good faith belief that such action is necessary to:
          </p>
          <ul className="list-disc list-inside text-muted-foreground mb-8">
            <li>To comply with a legal obligation</li>
            <li>To protect and defend the rights or property of Pomofocus</li>
          ...
          <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">Service Providers</h2>
          <p className="text-muted-foreground mb-4">
          ...
          <p className="text-muted-foreground mb-8">
            We work with third-party advertising partners to show you ads. Some of our advertising partners may use cookies and similar technologies to collect information about you when you use our service. For more information about how these partners may use your data, please see the Freestar Privacy Policy.
          </p>
